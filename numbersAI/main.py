...
class neuralNetwork:
    ...
    def save_weights(self, filename):
        numpy.savez(filename, wih=self.wih, who=self.who)
...
n.save_weights("neuralNetNodes")'''

n.load_weights("neuralNetNodes")
...
img_array = imageio.v3.imread('my_own_images/2828_my_own_3.png', mode='F')
